...
#     Porpu1328_1
#     Rhomari1
#   Tip: this is exactly the genome_id column of config/genomes.tsv, so you can
#   generate it with:  cut -f1 config/genomes.tsv | tail -n +2 > portal_ids.txt
#
# <category>
...
# repo).
#
# IMPORTANT: --use-non-public-portals true is REQUIRED for the current example
# dataset, because those 9 genomes live on PRIVATE Mycocosm/Phycocosm portals, not
# the public ones. Omitting this flag will silently return nothing (or an auth
# error) for genomes on private portals -- check whether it applies to your
# genomes too.
#
# ---------------------------------------------------------------------------
